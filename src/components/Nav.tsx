...
const Nav: React.FC = () => {
  ...
  return (
    <nav className="fixed top-0 left-1/2 transform -translate-x-1/2 mt-6 p-4 rounded-full bg-[#1a1a1a] bg-opacity-90 text-slate-50 shadow-md z-50">
      <ul className="flex items-center h-4 mx-4 space-x-8">
        <li className={`font-bruce font-regular text-xl py-2 px-4 rounded-full ${activeSection === 'home' ? 'bg-green-400 bg-opacity-70' : 'bg-opacity-0'} hover:bg-opacity-70`}>
